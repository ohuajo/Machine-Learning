...
k1,i_point1,k2,i_point2 = initial_S1('1417') # please replace 0111 with your last four digit of your ID
...
sum_squared_error = cluster1_squared_error + cluster2_squared_error + cluster3_squared_error
...
sum_squared_error = cluster1_squared_error + cluster2_squared_error + cluster3_squared_error + cluster4_squared_error + cluster5_squared_error
...
kmeans = KMeans(n_clusters=3, init=i_point1, n_init=1).fit(data2)
...
kmeans = KMeans(n_clusters=5, init=i_point2, n_init=1).fit(data2)
kmeans.cluster_centers_
